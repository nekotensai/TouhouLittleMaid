...
/**
 * OpenAI STT (Whisper): URL + optional Secret Key + model
 */
public class STTOpenAIFormLayout extends STTSiteFormLayout {
    public STTOpenAIFormLayout(STTSite sourceSite) {
        super(sourceSite);
    }

    @Override
    public List<FieldDescriptor> getFieldDescriptors() {
        STTOpenAISite site = (STTOpenAISite) this.sourceSite;
        return List.of(
    ...
    public @Nullable STTSite buildSite(Function<String, String> fieldValues, Consumer<Component> showStatus) {
        ...
        return new STTOpenAISite(site.id(), site.icon(), site.enabled(), url,
